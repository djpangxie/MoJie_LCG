...
class Player(Player_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "罗瑞安引路人.jpg"  # 卡牌的图像文件名
        self.card_image = pygame.image.load(os.path.join(self.card_dir, self.card_file)).convert()  # 卡牌的原始图像
        self.card_name = "罗瑞安引路人"  # 卡牌的名称
        ...
        self.card_attribute = ("西尔凡精灵", "斥候")  # 卡牌的属性文字标志，作为其他卡牌效果的目标判断
        self.rule_keyword = ()  # 卡牌的规则关键词，表示卡牌有些什么关键词
        self.rule_mark = ("响应",)  # 卡牌的规则效果标志，表示卡牌有些什么效果
        self.card_type = "盟友"  # 卡牌类型，表明本卡牌是英雄、盟友、附属还是事件

        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "响应：在指派罗瑞安引路人执行任务后，放置1枚进度标记到激活的地区上。"

        # 剧情描述的斜体文字
        self.describe_text = "“他们的确居住在林中很远的地方...” ——亚拉冈，《魔戒现身》"
