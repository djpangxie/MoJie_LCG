...
class Player(Player_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "矮人墓穴.jpg"  # 卡牌的图像文件名
        self.card_image = pygame.image.load(os.path.join(self.card_dir, self.card_file)).convert()  # 卡牌的原始图像
        self.card_name = "矮人墓穴"  # 卡牌的名称
        ...
        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "行动：从你的弃牌堆中返回一张精神派系的卡牌到你的手牌。"

        # 剧情描述的斜体文字
        self.describe_text = "矮人不再受人怜。远古矮人法术高，铁锤飞舞声音豪，幽深黑暗地底下，空洞大厅音喧闹。 ——《哈比人》"
            ...
            if self.card_order[2]:
                ...
                if self.main_game.playerdiscard_area.playerdiscard_deck:
                    for card in self.main_game.playerdiscard_area.playerdiscard_deck:
                        if card.card_type != "英雄" and hasattr(card, "faction_symbol") and card.faction_symbol == "精神":
                            cards.append(card)
                if cards:
