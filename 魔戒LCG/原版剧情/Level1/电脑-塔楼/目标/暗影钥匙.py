...
class Enemy(Enemy_Group):
    def __init__(self, main_game):
        ...
        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "守护.限制.\n行动：当本目标未附属时，上升2点你的威胁等级，以获取本目标。获取时，将暗影钥匙附属到你控制的一名英雄上。（视为一张附属牌。如果附属解除，将暗影钥匙返回场景区。）\n强制：在每回合结束时，所附属英雄受到1点伤害。"
