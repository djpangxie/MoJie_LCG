...
class Task(Task_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "10.jpg"  # 任务卡牌的图像文件名
        ...
        self.rule_text = "展示后：从遭遇牌组中搜寻一张山丘巨魔(如果没有山丘巨魔在场)，并将其放置进场景区中。将遭遇牌组洗牌。\n当山丘巨魔在场时，玩家不能通过本场景。"

        # 剧情描述的斜体文字
        self.describe_text = "当你正在靠近藏匿于河岸边的小木筏时，一只恐怖的山丘巨魔从乱石堆后猛然向你袭来！"
            ...
            if self.card_order[2]:
                ...
                if self.main_game.encounter_area.encounter_deck:
                    for card in self.main_game.encounter_area.encounter_deck:
                        if card.card_name == "山丘巨魔":
                            break
                if card is not None and card.card_name == "山丘巨魔":
