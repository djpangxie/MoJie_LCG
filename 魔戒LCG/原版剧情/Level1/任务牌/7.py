...
class Task(Task_Group):
    def __init__(self, main_game):
        ...
        # 剧情描述的斜体文字
        self.describe_text = "小径蜿蜒通向密林中一处最黑暗、最错综复杂的地方...\n你感觉到有个邪恶、黑暗的物体正在追捕你，你试图加快脚步迅速逃离这个恶魔。"
