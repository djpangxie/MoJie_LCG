...
class Player(Player_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "矮人战斧.jpg"  # 卡牌的图像文件名
        self.card_image = pygame.image.load(os.path.join(self.card_dir, self.card_file)).convert()  # 卡牌的原始图像
        self.card_name = "矮人战斧"  # 卡牌的名称
        ...
        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "限制.\n附属到一名英雄上。\n所附属英雄获得+1攻击力。（如果所附属英雄是矮人，则以+2攻击力代替。）"

        # 剧情描述的斜体文字
        self.describe_text = "“不过，请随时准备好你的弓箭，我也会备好我的斧头。” ——金雳，《双城奇谋》"
    ...
    def run_card_order(self):
        ...
        if self.card_order[0] == "打出附属后" and self.card_order[1] == 0:
            ...
            if self.card_order[2]:
                ...
                if "矮人" in self.select_hero.card_attribute or "属性+" in self.select_hero.active_condition and "矮人" in \
                        self.select_hero.active_condition["属性+"]:
                    self.select_hero.active_attack_force += 2
                else:
                    self.select_hero.active_attack_force += 1
                self.update_mask()
            ...
            if self.card_order[2]:
                ...
                for hero in self.active_condition["附属到"]:
                    ...
                    if "矮人" in hero.card_attribute or "属性+" in hero.active_condition and "矮人" in hero.active_condition[
                        "属性+"]:
                        hero.active_attack_force -= 2
                    else:
                        hero.active_attack_force -= 1
                    if hero.active_attack_force < 0:
                        hero.active_attack_force = 0
