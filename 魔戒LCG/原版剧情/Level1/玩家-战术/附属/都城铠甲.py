...
class Player(Player_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "都城铠甲.jpg"  # 卡牌的图像文件名
        self.card_image = pygame.image.load(os.path.join(self.card_dir, self.card_file)).convert()  # 卡牌的原始图像
        self.card_name = "都城铠甲"  # 卡牌的名称
        ...
        self.card_attribute = ("物品", "防具")  # 卡牌的属性文字标志，作为其他卡牌效果的目标判断
        ...
        # 剧情描述的斜体文字
        self.describe_text = "“去城堡的兵器库，穿戴好净白塔的制服和装备。” ——迪耐瑟，《王者再临》"
    ...
    def run_card_order(self):
        ...
        if self.card_order[0] == "打出附属后" and self.card_order[1] == 0:
            ...
            if self.card_order[2]:
                ...
                self.select_hero.active_health_point += 4
                self.update_mask()
            ...
            if self.card_order[2]:
                ...
                for hero in self.active_condition["附属到"]:
                    ...
                    if hero.active_health_point > 0:
                        hero.active_health_point -= 4
                        if hero.active_health_point < 1:
                            hero.active_health_point = 1
