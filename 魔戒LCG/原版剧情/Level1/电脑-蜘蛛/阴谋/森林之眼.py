...
class Enemy(Enemy_Group):
    def __init__(self, main_game):
        ...
        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "展示后：每位玩家弃除他手牌中所有的事件牌。"

        # 卡牌有暗影效果的话，代表其暗影效果的文字说明
        self.shadow_text = ""

        # 剧情描述的斜体文字
        self.describe_text = "...他会看见四周的黑暗中有许多的微光闪耀；有时，黄色，绿色或是红色的双眼，会从不远的地方瞪视着他们，然后，这些光芒会慢慢地黯淡下来，又从不远处再度亮起。 ——《哈比人》"
