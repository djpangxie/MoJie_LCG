...
class Enemy(Enemy_Group):
    def __init__(self, main_game):
        ...
        self.card_file = "邪恶的暴风雪.jpg"  # 卡牌的图像文件名
        self.card_image = pygame.image.load(os.path.join(self.card_dir, self.card_file)).convert()  # 卡牌的原始图像
        self.card_amount = (2, 3, 3)  # 这张卡牌在简单、普通和噩梦难度下分别放多少张
        self.card_name = "邪恶的暴风雪"  # 这张卡的名称
        ...
        # 规则文字，本卡牌在场时的特殊能力
        self.rule_text = "展示后：对每位威胁等级等于或高于35的玩家所控制的每名角色造成1点伤害。"

        # 卡牌有暗影效果的话，代表其暗影效果的文字说明
        self.shadow_text = ""

        # 剧情描述的斜体文字
        self.describe_text = "“在我的故乡，他们说他可以指挥黯影山脉上的暴风雪...” ——波罗莫，《魔戒现身》"
